...
<audio id="audio_1" src="samples/chorale/088-h0.5-p0.5.mp3" type="audio/mpeg" controls controlsList="nodownload">Your browser does not support the audio element.</audio>
<center><a id="score_1" href="samples/chorale/088-h0.5-p0.5.pdf" target="_blank">Score of Helft mir Gotts Güte preisen</a></center>
